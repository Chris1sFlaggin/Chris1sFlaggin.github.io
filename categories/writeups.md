...
<div class="content-side" style="padding: 2rem 1.5rem; width: 100%; box-sizing: border-box;">
  <h2 class="section-title" style="color: #64ffda; text-transform: uppercase; border-bottom: 1px solid rgba(100, 255, 218, 0.2); padding-bottom: 0.5rem; margin-bottom: 2rem;">Select</h2>
