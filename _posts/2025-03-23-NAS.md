...
<!-- Sistema di Like con Fiamme -->
<div id="like-system" style="text-align: center; margin: 20px 0; padding: 15px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
  ...
  <div id="like-count" style="margin-top: 10px; font-weight: bold; color: #333;">
    <span id="count-number">0</span> fiamme
  </div>
  <div id="like-status" style="margin-top: 5px; font-size: 0.9em; color: #666;"></div>
</div>

<script>
(function() {
  const STORAGE_KEY = 'nas-post-likes';
  const LIKED_KEY = 'nas-post-liked';
  ...
  let totalLikes = parseInt(localStorage.getItem(STORAGE_KEY) || '0');
  let hasLiked = localStorage.getItem(LIKED_KEY) === 'true';
  
  function updateUI() {
    countNumber.textContent = totalLikes;
    
    if (hasLiked) {
      flameIcon.style.transform = 'scale(1.3)';
      flameIcon.style.filter = 'drop-shadow(0 0 8px orange)';
      likeBtn.style.background = 'linear-gradient(45deg, #ff6b35, #ff8e53)';
      likeBtn.style.borderRadius = '50%';
      likeBtn.style.padding = '10px';
      likeStatus.textContent = '✨ Hai messo una fiamma!';
      likeStatus.style.color = '#ff6b35';
    } else {
      flameIcon.style.transform = 'scale(1)';
      flameIcon.style.filter = 'grayscale(50%)';
      likeBtn.style.background = 'none';
      likeBtn.style.padding = '5px';
      likeStatus.textContent = '👆 Clicca per dare una fiamma!';
      likeStatus.style.color = '#666';
    }
  }
  ...
  function toggleLike() {
    if (hasLiked) {
      ...
      hasLiked = false;
      likeStatus.textContent = '🔥 Fiamma rimossa';
      ...
      totalLikes++;
      hasLiked = true;
      likeStatus.textContent = '🔥 Fiamma aggiunta!';
    ...
    // Salva stato
    localStorage.setItem(STORAGE_KEY, totalLikes.toString());
